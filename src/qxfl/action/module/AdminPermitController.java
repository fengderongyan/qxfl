...
import qxfl.service.module.AdminPermitService;
...
public class AdminPermitController extends BaseController {
    ...
    {
        request.setAttribute("roles", adminPermitService.getRoleList());
        request.setAttribute("roleId", req.getValue(request, "role_id"));
        return COM_PATH +"qxfl/module/adminmodule/permit/role_query";
    }
    ...
    public String queryPermit() {
        return COM_PATH +"qxfl/module/adminmodule/modulepermit/modulepermit_query";
    }
    ...
    public String showReplaceRole(HttpServletResponse response) {
        request.setAttribute("roleList", adminPermitService.getRoleList());
        request.setAttribute("roleStrs", adminPermitService.getRolesByModuleId(request));
        return COM_PATH +"qxfl/module/adminmodule/modulepermit/ajaxModuleRole";
    }
