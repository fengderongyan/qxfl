...
import qxfl.service.module.PermitService;
...
public class PermitController extends BaseController {
    ...
    public String roleQuery() {
        ...
        return COM_PATH + "qxfl/module/module/permit/role_query";
    }
    ...
    public String queryPermit() {
        return COM_PATH +"qxfl/module/module/modulepermit/modulepermit_query";
    }
    ...
    public String showReplaceRole(HttpServletResponse response) {
        ...
        return COM_PATH +"qxfl/module/module/modulepermit/ajaxModuleRole";
    }
