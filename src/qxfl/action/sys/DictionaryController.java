...
import qxfl.service.sys.DictionaryService;
...
public class DictionaryController extends BaseController {
    ...
    public String dictionaryFrame(){
        request.setAttribute("typeList", dictionaryService.getDictionaryType());
        return COM_PATH +"qxfl/sys/dictionary/dictionaryFrame";
    }
    ...
    public String dictionaryList(){
        ...
        return COM_PATH +"qxfl/sys/dictionary/dictionaryList";
    }
    ...
    public String dictionaryEdit(){
        ...
        return COM_PATH +"qxfl/sys/dictionary/dictionaryEdit";
    }
    ...
    public String ajaxMaxInfoId(){
        ...
        return COM_PATH + "qxfl/sys/dictionary/ajaxspan";
    }
