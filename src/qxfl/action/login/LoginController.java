...
//                logger.debug("修改密码");
//                return "redirect:/sys/personalsetting/changePassWord.do?operator_id="+operator_id;
//            }
           return "redirect:/login/index.do"; 
		}
		
		return COM_PATH +"qxfl/login/loginResult";
	}
    ...
    public String editPwdFrame(){
        return COM_PATH +"qxfl/login/editPwd";
    }
