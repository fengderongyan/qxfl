...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<display:table name="list" requestURI="${app}/cgjc/cgjc/ddyList.do"
			...
			<display:column title="打印次数" property="ydy_num"  />
			<display:column title="操作" media="html" style="width:150px;">
				...
				<zcc:button cssClass="smallBtn_gray"
					onclick="yl('${row.id}');return false;">信息预览</zcc:button>&nbsp; 
			</display:column>
		</display:table>
	</body>
	<script type="text/javascript">
		...
		function yl(infoId){
			MyWindow.OpenCenterWindowScroll('${app}/cgjc/cgjc/ddyShowInfo.do?infoId='+infoId, 'showInfo', 700, 800);
		}
