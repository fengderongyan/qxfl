	...
	<body>
		...
		<script type="text/javascript">
			...
			function jump() 
			{
				...
				win = window.open(url, '连云港市长虹防雷工程中心' + Math.round(Math.random() * 1000), 'height='+height+', width='+width+', top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no, directories=no');
