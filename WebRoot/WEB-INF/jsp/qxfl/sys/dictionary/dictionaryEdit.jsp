				...
				<table class="detail_table" cellspacing="0" cellpadding="0" style="width: 100%;">
					...
					<tr>
						...
						<td class="outDetail2" colspan="3">
							<input type="radio" id="addType" name="addType" value="1" checked="checked" onchange="changeRadio();return false;" >新增字典信息</input>&nbsp;&nbsp;
							<input type="radio" id="addType" name="addType" value="2" onchange="changeRadio();return false;" >新增字典类型</input>
						</td>
					</tr>
					</c:if>
					<span>
					...
					<tr id="addTypeInfo">
						...
						<td class="outDetail2" colspan="3">
							<zcc:select list="typeList" name="data_type_code2" id="data_type_code2" onchange="changType();"
