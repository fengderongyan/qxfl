...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<display:table name="roleList" requestURI="${app}/sys/rolecfg/roleList.do"
			...
			<display:column title="状态" property="state" />
			<display:column title="角色排序" property="role_order"  />
			<display:column title="操作人" property="name"  />
			...
			<display:column title="操作" media="html" style="width:220px;">
					<zcc:button cssClass="smallBtn_gray"
						onclick="edit('${row.role_id}','show');return false;">详细</zcc:button>&nbsp;
					<zcc:button cssClass="smallBtn_gray"
						onclick="edit('${row.role_id}','edit');return false;">修改</zcc:button>&nbsp;
					<zcc:button cssClass="smallBtn_gray"
						onclick="del('${row.role_id}');return false;">删除</zcc:button>&nbsp;
			</display:column>
		</display:table>
	</body>
	<script type="text/javascript">
      ...
      　　		MyWindow.OpenCenterWindowScroll('${app}/sys/rolecfg/roleEdit.do?role_id='+role_id+'&method='+method,'editrole',608,800);
    	}
