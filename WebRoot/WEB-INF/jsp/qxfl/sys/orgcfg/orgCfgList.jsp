		...
		<display:table name="orgList" requestURI="${app}/sys/orgcfg/orgCfgList.do"
			...
			<display:column title="操作" media="html" style="width:150px;">
				<zcc:button cssClass="smallBtn_gray"
					onclick="editOrg('${row.org_id}','${row.IS_BRANCH_ROOT}','show');return false;">详细</zcc:button>&nbsp;
				<zcc:button cssClass="smallBtn_gray"
					onclick="editOrg('${row.org_id}','${row.IS_BRANCH_ROOT}','edit');return false;">修改</zcc:button>&nbsp;
				<zcc:button cssClass="smallBtn_gray"
					onclick="deleteOrg('${row.org_id}');return false;">删除</zcc:button>&nbsp;
			</display:column>
		</display:table>
	</body>
