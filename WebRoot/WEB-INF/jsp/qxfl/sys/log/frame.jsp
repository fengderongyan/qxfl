...
<html>
	...
	<body>
		...
		<div id="tabsModuleRole" class="easyui-tabs" data-options="fit:true,border:false">
			...
			<div id="easytab3" title="信息下载流水">
				<iframe id="infodownload" frameborder="0" height="99.5%" width="100%" scrolling="no"
					src=""></iframe>
			</div>
		</div>
			...
			onSelect:function(title){
				...
				if('easytab1'==tbid){
					...
					if($('#tabsId').val() != 'easytab3'){
						$('#infodownload').attr('src', '${app}/sys/log/infoDownloadHisFrame.do');
						$('#tabsId').val('easytab3');
					}
				}
			}
