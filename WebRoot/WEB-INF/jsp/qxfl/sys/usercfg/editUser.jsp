...
<body>
				...
				<table class="form_table" cellspacing="0" cellpadding="0" style="width: 100%;">
					<tr height="20">
						...
						<td class="outDetail2">
							<c:choose>
								<c:when test="${param.method=='create'}">
									<input type="number" id="operator_id" name="operator_id" value="${userInfo.operator_id}" 
					...
					<tr height="20">
						...
						<td width="30%" class="outDetail2">
							<input type="text" id="mobile" name="mobile" maxlength="11" style="width: 90%;"
								value="${userInfo.mobile}" required="true" dataType="Mobile" msg="手机号不正确" />
						</td>
						<td width="20%" class="outDetail">
							邮箱：
						</td>
	...
	<div class="hintInfo"><strong>温馨提示：</strong>
		<div>a)新增用户初始密码为：工号后三位+手机号码后三位。</div>
	</div>
</body>
<script type="text/javascript" defer="defer">
	...
	function errorCheck() { 
		...
		var params2 = 'operator_id='+$('#operator_id').val()+'&mobile='+$('#mobile').val() + '&method='+'${param.method}';
