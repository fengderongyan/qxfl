...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="zcc" scroll="no">
		<form id="zTreeForm" name="dTreePostForm" method="post" action="${app}/adminpermit/roleSave.do">
			<zcc:csrfToken />
		   	 <div style="overflow: hidden;">
			   	 <div align="center" style="margin-top: 5px;"> 
			    	&nbsp;&nbsp;角色视野：
						<zcc:select list="${roles}" id="role_id" name="role_id" onchange="cha(this.value);"
							headValue="" optionLabel="ROLE_NAME" optionValue="ROLE_ID"  
							value="${roleId}" style="width:300px;" />
						&nbsp;&nbsp;
						<label id="dis_none">
						<zcc:button cssClass="ovalbutton" onclick="save(this);">保 存</zcc:button></label>
	...
	function chanageRole(){
		...
		window.location.href="${app}/adminpermit/roleQuery.do?role_id="+role_id;
	}
	</script>
	<!-- ZTree 异步请求加载树 -->
	<script type="text/javascript">
		...
		function getUrl(treeId, treeNode) {
			...
			return "${app}/adminpermit/loadModulePermit.do?" + param;
		}
		...
		$(document).ready(function(){
			var role_id = $('#role_id').val();
			//初始化组织树
			var url1 = '${app}/adminpermit/loadModulePermit.do?role_id='+role_id;
