...
<html>
	...
	//点击模块树 角色
	function editModulePermit(module_id,isParent) {
		$('#module_id').val(module_id);
		var url = "";
		if(!isParent){
			url = '${app}/adminpermit/showReplaceRole.do?module_id='+module_id;
	...
	function saveModuleRole(src) {
		...
		var url = '${app}/adminpermit/saveModuleRole.do';
	...
	<script type="text/javascript">
		...
		function beforeClick(treeId, treeNode) {
			editModulePermit(treeNode.id,treeNode.isParent);
		}
		...
		$(document).ready(function(){
			//初始化组织树
			var url1 = '${app}/adminpermit/loadModulePermit.do';
		...
		function showTree(req){
			...
			zTreeMenuTree.expandNode(zTreeMenuTree.getNodeByParam("id", "0"));
		}
	</script>
</html>