...
<html>
	...
	<body class="zcc" scroll="no">
		<form id="form2" name="form2" action="" method="post">
			...
			<br />
			<p align="center">
				<zcc:button cssClass="ovalbutton" onclick="isOK(this);return false;">确 定</zcc:button>
				&nbsp;&nbsp;
	...
	<script type="text/javascript">
		...
		function getUrl(treeId, treeNode) {
			...
			return "${app}/adminmodule/loadSuperiorModule.do?" + param;
		}
		...
		$(document).ready(function(){
			//初始化组织树
			var url1 = '${app}/adminmodule/loadSuperiorModule.do?superior_id='+module_id;
