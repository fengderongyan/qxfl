...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<form id="zTreeForm">
			...
			<div id="title" style='position: absolute; width: 100%; z-index: 20; left: 0px; top: 10px; overflow: hidden;'>
				<div style="text-align: center">
					<zcc:button cssClass="ovalbutton" onclick="add();return false;">新 增</zcc:button>
				</div>
	...
	<script language="javascript">
		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/module/editModule.do?action=add', 'addModule', 650, 850);
		}
		...
		function beforeClick(treeId, treeNode) {
			...
			MyWindow.OpenCenterWindowScroll('${app}/module/editModule.do?action=update&module_id='+treeNode.id, 'editModule', 650, 850);
		}
		...
		function loadOrgTree(){
			var url = '${app}/module/loadModuleList.do';
