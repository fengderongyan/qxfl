...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/cgjc/cgjc/tkdybhqList.do" target="listQuery">
	...
	<script type="text/javascript">
		...
		sch();
  		...
  		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/cgjc/cgjc/tkdybhqEdit.do?method=create&base_id='+'${base_id}','addtkdybhq',550,800);
		}
