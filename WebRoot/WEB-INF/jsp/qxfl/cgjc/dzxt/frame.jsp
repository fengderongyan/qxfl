...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/cgjc/cgjc/dzxtList.do" target="listQuery">
					...
					<table class="search" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="outDetail2" style="width: 100px;">
								<input type="text" id="jf_name" name="jf_name" />
							</td>
						</tr>
					</table>
	...
	<script type="text/javascript">
		...
		sch();
  		...
  		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/cgjc/cgjc/dzxtEdit.do?method=create&base_id='+'${base_id}','addDzxt',800,900);
		}
