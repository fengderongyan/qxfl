...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/cgjc/cgjc/dqdybhqList.do" target="listQuery">
			...
			<div id="queryPanel" class="queryPanel">
				...
				<div id="queryPanel_content" class="queryPanel_content"
					...
					<table class="search" cellspacing="0" cellpadding="0">
						<tr>
							<td class="outDetail" style="width: 75px;">
								被测物位置：
							</td>
	...
	<script type="text/javascript">
		...
		sch();
  		...
  		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/cgjc/cgjc/dqdybhqEdit.do?method=create&base_id='+'${base_id}','editDqdybhq',800,800);
		}
