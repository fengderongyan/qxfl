...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/cgjc/cgjc/clscList.do" target="listQuery">
				...
				<div id="queryPanel_content" class="queryPanel_content"
					...
					<div id="queryPanel_footer" class="queryPanel_footer"
						...
						<c:if test="${flag == 1 &&  empty cflag }">
							<zcc:button id="schbtn" cssClass="ovalbutton" onclick="add();return false;">材料上传</zcc:button>
						</c:if>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		sch();
  		...
  		function add() {
			MyWindow.OpenCenterWindowScroll('${app}/cgjc/cgjc/clscEdit.do?base_id='+'${base_id}','editClsc',250,650);
		}
