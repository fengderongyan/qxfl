...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/cgjc/cgjc/djhList.do" target="listQuery">
			...
			<div id="queryPanel" class="queryPanel">
				...
				<div id="queryPanel_content" class="queryPanel_content"
					...
					<div id="queryPanel_footer" class="queryPanel_footer"
						...
						&nbsp;&nbsp;
						<zcc:button id="schbtn" cssClass="ovalbutton" onclick="sch();return false;">查询</zcc:button>
					</div>
				</div>
			</div>
		</form>
