...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<display:table name="list" requestURI="${app}/cgjc/cgjc/dtjList.do"
			...
			<display:column title="操作" media="html" style="width:130px;">
				...
				<zcc:button cssClass="smallBtn_gray"
					onclick="tj('${row.id}');return false;">提交</zcc:button>&nbsp; 
			</display:column>
		</display:table>
	</body>
	<script type="text/javascript">
		...
		function tj(infoId){
			if(window.confirm('确定提交该报告？')){
				var res = new MyJqueryAjax('${app}/cgjc/cgjc/tjBg.do','id='+infoId).request();
				if(res==1){
					alert('提交成功！');
