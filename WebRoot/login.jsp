...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background-color:white;">
		...
		<div class="login_top">
			...
			<div class="login_menu">
				...
				<a tabindex="1" href="javascript:void(0);"
					onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://10.33.194.22:8090/qxfl/login.jsp');this.blur();">设为首页</a>
			</div>
		</div>
		...
		<div id="codeDiv" style="display:none;height: 280px;width: 600px;text-align: center;" class="demo" >
			...
			<table class="zcc" id="td1" cellspacing="0" cellpadding="0" style="width: 100%;">
				<tr height="30" >
	...
	<script type="text/javascript">
		...
		*/
		...
		function init() {
			$('#loginName').val(getCookie("operator_id_qxfl") || "请输入登录名或手机号");
		...
		function login(){
			...
			SetCookie ("operator_id_qxfl", $('#loginName').val());
			SetCookie ("loginType_qxfl", $('#loginType').val());
			SetCookie ("passwd_qxfl", $('#loginPassword').val());
		...
		function editpwd(result){
			...
			MyWindow.OpenCenterWindowScroll("${app}/login/editPwdFrame.do?flag="+result+"&pass="+pass+"&operator_id="+operatorId,"editPwdQxfl", "260"," 400");
		...
		function changeLoginType(){
			...
			SetCookie ("loginType_qxfl", loginType);
