...
if(typeof zcc == "undefined") var zcc = new Object();
if(typeof zcc.FusionChartsUtil == "undefined") zcc.FusionChartsUtil = new Object();
zcc.FusionCharts = function () {
	this.id = "";
	this.fChart = null;
...
if(typeof zcc.FusionChartsUtil.charts == "undefined") zcc.FusionChartsUtil.charts = new Object();
zcc.FusionChartsUtil.addChart = function(id, value) {
	this.charts[id] = value;
};
zcc.FusionChartsUtil.getChart = function(id){
	return this.charts[id];
};
zcc.FusionChartsUtil.makeChart = function (param) {
	var chart = this.getChart(param.id);
	if(chart == null) {
		chart = new zcc.FusionCharts();
		this.initChart(chart, param);
		this.makeXML(chart);
		var fChart = new FusionCharts('/qxfl/FusionCharts/swf/' + chart.chartType + '.swf', chart.id, 
 ...
 * 初始化chart配置
 */
zcc.FusionChartsUtil.initChart = function (chart, param) {
	chart.id = param.id;
 ...
 */
zcc.FusionChartsUtil.makeXML = function (chart) {
	var xml = chart.xml;
 ...
 */
zcc.FusionChartsUtil.makeXMLAttr = function (obj, attr, prop) {
